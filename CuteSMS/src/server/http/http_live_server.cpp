...
bool HttpLiveServer::register_route() {
    ...
    // ret = on_get("/:app/:stream.mp4", [](std::shared_ptr<HttpServerSession> session,
    ...
    // ret = on_get("/:app/:stream.mpd", [](std::shared_ptr<HttpServerSession> session,
    // std::shared_ptr<HttpRequest> req, std::shared_ptr<HttpResponse> resp)->boost::asio::awaitable<void> {
    //     (void)session;
    ...
    // ret = on_get("/:app/:stream/:id.m4s", [](std::shared_ptr<HttpServerSession> session,
    // std::shared_ptr<HttpRequest> req, std::shared_ptr<HttpResponse> resp)->boost::asio::awaitable<void> {
    //     (void)session;
    ...
    // ret = on_post("/api/on_publish", [](std::shared_ptr<HttpServerSession<HttpConn>> session,
    // std::shared_ptr<HttpRequest> req, std::shared_ptr<HttpResponse> resp)->boost::asio::awaitable<void> {
    //     (void)req;
    //     (void)resp;
    //     (void)session;
    ...
    // ret = on_get("/api/streams_count", [](std::shared_ptr<HttpServerSession<HttpConn>> session,
    // std::shared_ptr<HttpRequest> req, std::shared_ptr<HttpResponse> resp)->boost::asio::awaitable<void> {
    //     (void)req;
    //     (void)session;
    ...
    // ret = on_get("/api/streams_info", [](std::shared_ptr<HttpServerSession<HttpConn>> session,
    // std::shared_ptr<HttpRequest> req, std::shared_ptr<HttpResponse> resp)->boost::asio::awaitable<void> {
    //     (void)req;
    //     (void)session;
    //     resp->add_header("Content-Type", "application/json");
...
boost::asio::awaitable<void> HttpLiveServer::response_json(std::shared_ptr<HttpResponse> resp, int32_t code,
