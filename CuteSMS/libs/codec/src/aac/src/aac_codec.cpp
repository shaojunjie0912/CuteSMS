...
std::shared_ptr<AudioSpecificConfig> AACCodec::get_audio_specific_config() { return audio_specific_config_; }

std::shared_ptr<AUConfig> AACCodec::get_au_config() { return au_config_; }

std::shared_ptr<Payload> AACCodec::get_payload() { return sdp_payload_; }
}  // namespace cutesms