 ...
 * @Description:
 * @FilePath: \cutesms\cutesms\core\rtsp_media_source.hpp
...
public:
    ...
    std::shared_ptr<Sdp> get_announce_sdp() { return announce_sdp_; }

    void set_announce_sdp(std::shared_ptr<Sdp> sdp) { announce_sdp_ = sdp; }

    void set_audio_pt(uint16_t v) { audio_pt_ = v; }

    void set_video_pt(uint16_t v) { video_pt_ = v; }
