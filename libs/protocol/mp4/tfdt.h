...
// The media timeline, of the first sample in decode order in the track fragment. This can be useful, for
// example, when performing random access in a file; it is not necessary to sum the sample durations of all
// preceding samples in previous fragments to find this value (where the sample durations are the deltas in
// the Decoding Time to Sample Box and the sample_durations in the preceding track runs).
