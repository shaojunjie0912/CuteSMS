...
public:
    ...
    uint8_t get_pt() { return header_.get_pt(); }

    RtcpFbHeader &get_header() { return header_; }

    void set_ssrc(uint32_t v) { header_.sender_ssrc = v; }

    void set_media_source_ssrc(uint32_t v) { header_.media_source_ssrc = v; }
