...
public:
    ...
    // scale units, in composition time). If this field is set to –1, it is an empty edit. The last edit in a
...
public:
    // specifies the relative rate at which to play the media corresponding to this edit segment. If this
    // value is 0, Then the edit is specifying a ‘dwell’: the media at media-time is presented for the
