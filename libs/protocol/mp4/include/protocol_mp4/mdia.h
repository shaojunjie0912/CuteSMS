...
public:
    void set_hdlr(std::shared_ptr<HdlrBox> hdlr) { hdlr_ = hdlr; }

    std::shared_ptr<HdlrBox> get_hdlr() { return hdlr_; }

    void set_mdhd(std::shared_ptr<MdhdBox> mdhd) { mdhd_ = mdhd; }

    std::shared_ptr<MdhdBox> get_mdhd() { return mdhd_; }

    void set_minf(std::shared_ptr<MinfBox> minf) { minf_ = minf; }

    std::shared_ptr<MinfBox> get_minf() { return minf_; }
