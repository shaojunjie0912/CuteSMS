...
const std::string& TsSegment::get_filename() { return filename_; }

void TsSegment::set_filename(const std::string& filename) { filename_ = filename; }

void TsSegment::set_seqno(int64_t v) { seq_ = v; }

int64_t TsSegment::get_seqno() { return seq_; }

int64_t TsSegment::get_audio_start_pts() { return start_pts_audio_; }

int64_t TsSegment::get_audio_end_pts() { return end_pts_audio_; }
...
int64_t TsSegment::get_start_pts() { return std::min(start_dts_video_, start_pts_audio_); }
...
int32_t TsSegment::get_curr_ts_chunk_offset() { return ts_chunk_off_; }

int32_t TsSegment::get_curr_ts_chunk_index() { return ts_chunk_index_; }

std::vector<boost::asio::const_buffer> TsSegment::get_ts_seg(size_t chunk_index, size_t chunk_off,
                                                             int32_t bytes) {
...
int64_t TsSegment::get_ts_bytes() { return total_ts_bytes_; }
