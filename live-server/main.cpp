...
int main(int argc, char *argv[]) {
    ...
    try {
        opts.add_options()("version,v", "show the version")(
            ...
            "help,h", "cutesms is a multi media server.")("debug,d", "output debug log to console.");
    ...
    if (vm.count("debug")) {
        ...
        spdlog::info("cutesms-server version:{}", VERSION_STR);
        return 0;
    }
