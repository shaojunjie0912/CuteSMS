...
void RtspResponse::add_header(const std::string& k, const std::string& v) { headers_[k] = v; }
...
void RtspResponse::set_body(const std::string& body) { body_ = body; }

const std::string& RtspResponse::get_body() const { return body_; }
...
const std::string& RtspResponse::get_version() const { return version_; }

int32_t RtspResponse::get_status_code() const { return status_code_; }

const std::string& RtspResponse::get_msg() const { return reason_; }
