...
public:
    ...
    std::string &get_session_name() { return session_name_; }

    void set_session_type(const std::string &session_type) { session_type_ = session_type; }

    const std::string &get_session_type() { return session_type_; }

    void set_param(const std::string &key, const std::string &val) { params_[key] = val; }
