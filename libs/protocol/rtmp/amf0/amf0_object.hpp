...
public:
    ...
    int32_t get_property_count() const { return properties_.size(); }

    const std::unordered_map<std::string, Amf0Data *> &get_value() { return properties_; }

    void set_value(std::unordered_map<std::string, Amf0Data *> &v) { properties_ = v; }
