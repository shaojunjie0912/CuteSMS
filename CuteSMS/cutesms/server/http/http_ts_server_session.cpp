...
HttpTsServerSession::HttpTsServerSession(std::shared_ptr<HttpRequest> http_req,
...
HttpTsServerSession::~HttpTsServerSession() { CORE_INFO("destroy HttpTsServerSession"); }
