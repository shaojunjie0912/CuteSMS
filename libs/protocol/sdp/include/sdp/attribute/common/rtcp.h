...
public:
    ...
    const std::string& get_net_type() { return nettype; }

    void set_net_type(const std::string& nt) { nettype = nt; }

    const std::string& get_addr_type() { return addrtype; }

    void set_addr_type(const std::string& at) { addrtype = at; }

    const std::string& get_connection_address() { return connection_address; }

    void set_connection_address(const std::string& ca) { connection_address = ca; }
