...
size_t Chunk::get_remaining_bytes() { return allocated_bytes_ - used_bytes_; }

size_t Chunk::get_used_bytes() const { return used_bytes_; }

std::string_view Chunk::get_remaining_buf() {
    return std::string_view((char *)buf_.get() + used_bytes_, get_remaining_bytes());
}

std::string_view Chunk::get_raw_buf() { return std::string_view((char *)buf_.get(), allocated_bytes_); }

size_t Chunk::pos() { return used_bytes_; }

void Chunk::skip(size_t bytes) { used_bytes_ += bytes; }
