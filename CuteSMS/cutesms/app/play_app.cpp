...
std::shared_ptr<PublishApp> PlayApp::get_publish_app() { return publish_app_; }

void PlayApp::set_publish_app(std::shared_ptr<PublishApp> publish_app) { publish_app_ = publish_app; }
