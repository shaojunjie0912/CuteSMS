...
// 在 rtx 的语义中，rtx 重传包不仅有不同于被重传包的 pt 值，也有不同的 ssrc 值，rtx ssrc 在 ssrc-group
// 字段中，如下是 video media level 示例： a=ssrc-group:FID 3473705511 683075964 a=ssrc:3473705511
// cname:wJobAtYmVV7u5Y3x a=ssrc:3473705511 msid:g4n21yfXiVM9K1CrtoSZMNxoNI7kBbY9rHgp
// 0befb6f8-46a8-4890-9955-b53689962daf a=ssrc:3473705511 mslabel:g4n21yfXiVM9K1CrtoSZMNxoNI7kBbY9rHgp
...
public:
    ...
    std::unordered_map<uint32_t, Ssrc>& get_ssrcs() { return ssrcs_; }

    void add_ssrc(const Ssrc& ssrc) { ssrcs_[ssrc.get_id()] = ssrc; }
