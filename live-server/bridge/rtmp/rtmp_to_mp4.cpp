 ...
 * @Description:
 * @FilePath: \cutesms\cutesms\server\transcode\rtmp_to_ts.cpp
...
#include "codec_aac/mpeg4_aac.hpp"
...
bool RtmpToMp4::init() {
    ...
    rtmp_media_sink_->on_rtmp_message(
        [this,
         self](const std::vector<std::shared_ptr<RtmpMessage>> &rtmp_msgs) -> boost::asio::awaitable<bool> {
