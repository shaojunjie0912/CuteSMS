 ...
 * @Description:
 * @FilePath: \cutesms\cutesms\server\transcode\rtmp_to_flv.hpp
...
public:
    RtmpToFlv(ThreadWorker *worker, std::shared_ptr<PublishApp>, std::weak_ptr<MediaSource> origin_source,
