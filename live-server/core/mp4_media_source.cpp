...
Mp4MediaSource::Mp4MediaSource(ThreadWorker *worker, std::weak_ptr<StreamSession> session,
...
bool Mp4MediaSource::init() { return true; }
...
std::shared_ptr<MediaBridge> Mp4MediaSource::get_or_create_bridge(const std::string &id,
                                                                  std::shared_ptr<PublishApp> app,
