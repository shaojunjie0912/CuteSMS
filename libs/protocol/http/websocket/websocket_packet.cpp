...
void WebSocketPacket::set_opcode(OpCode opcode) { opcode_ = opcode; }
...
int32_t WebSocketPacket::encode_header(char *data, int32_t len, OpCode opcode, bool fin, bool mask_flag,
...
int32_t WebSocketPacket::size() { return 2 + (mask_ ? 4 : 0) + payload_len_; }

std::string_view WebSocketPacket::get_payload() { return std::string_view(payload_.get(), payload_len_); }
}  // namespace cutesms