...
char MdhdBox::language0() { return (char)(((language_ >> 10) & 0x1f) + 0x60); }

void MdhdBox::set_language0(char v) { language_ |= uint16_t((uint8_t(v) - 0x60) & 0x1f) << 10; }

char MdhdBox::language1() { return (char)(((language_ >> 5) & 0x1f) + 0x60); }

void MdhdBox::set_language1(char v) { language_ |= uint16_t((uint8_t(v) - 0x60) & 0x1f) << 5; }
