...
// This is a container box for a single track of a presentation. A presentation consists of one or more
// tracks. Each track is independent of the other tracks in the presentation and carries its own temporal and
