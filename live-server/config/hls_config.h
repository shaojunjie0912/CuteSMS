...
public:
    ...
    int32_t ts_min_seg_dur() const { return ts_min_seg_dur_; }

    int32_t ts_max_seg_dur() const { return ts_max_seg_dur_; }

    int64_t ts_max_size() const { return ts_max_size_; }

    uint32_t min_ts_count_for_m3u8() const { return min_ts_count_for_m3u8_; }
