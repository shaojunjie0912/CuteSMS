...
public:
    ...
    // defined in Table 2. As an expandable class the size of each class instance in bytes is encoded and
    // accessible through the instance variable sizeOfInstance (see 8.3.3).
