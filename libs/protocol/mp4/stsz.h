...
public:
    ...
    // contains that size value. If this field is set to 0, then the samples have different sizes, and those
    // sizes are stored in the sample size table. If this field is not 0, it specifies the constant sample
    // size, and no array follows.
