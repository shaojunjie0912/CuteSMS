...
void MoovBox::add_box(std::shared_ptr<Box> child) { boxes_.push_back(child); }
...
MoovBuilder::MoovBuilder(Mp4Builder& builder) : builder_(builder) { builder_.begin_box(BOX_TYPE_MOOV); }
