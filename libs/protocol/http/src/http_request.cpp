...
HTTP_METHOD HttpRequest::get_method() const { return method_; }
...
const std::string &HttpRequest::get_path() const { return path_; }
...
void HttpRequest::add_header(const std::string &k, const std::string &v) { headers_[k] = v; }
...
void HttpRequest::add_query_param(const std::string &k, const std::string &v) { query_params_[k] = v; }
...
void HttpRequest::add_path_param(const std::string &k, const std::string &v) { path_params_[k] = v; }

std::unordered_map<std::string, std::string> &HttpRequest::path_params() { return path_params_; }

void HttpRequest::set_scheme(const std::string &scheme) { scheme_ = scheme; }

const std::string &HttpRequest::get_scheme() const { return scheme_; }

const std::string &HttpRequest::get_version() { return version_; }

void HttpRequest::set_version(const std::string &v) { version_ = v; }

const std::string &HttpRequest::get_version() const { return version_; }

void HttpRequest::set_body(const std::string &body) { body_ = body; }

const std::string &HttpRequest::get_body() const { return body_; }
